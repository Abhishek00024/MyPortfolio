...
export default function Achievements({ darkMode }) {
  const achievements = [
    ...
    {
      title: 'Project Competetions & Rankings',
      category: 'Competitive Programming',
      description: 'Achieved First place under the IEEE Student Project Competition 2026 at the Faculty of Information Technology & Engineering, Gopal Narayan Singh University, Sasaram(Bihar),',
    ...
    },
    {
      ...
      description: 'Successfully architected and deployed interactive models (AI CAREER NAVIGATOR) and fully responsive Requitment Portal to active public servers.',
