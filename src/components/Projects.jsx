  ...
  const projects = [
    {
      ...
      description: 'An AI-powered career guidance platform that provides personalized recommendations and insights to help users navigate their professional paths effectively.',
      features: [
        'AI-driven career assessment and recommendation engine',
        'Interactive dashboard for tracking progress and setting goals',
    ...
    {
      id: 'Doctor Appointment Booking Portal',
      title: 'Doctor Appointment Booking Portal',
      subtitle: 'Healthcare Management System',
      description: 'A comprehensive healthcare management platform that streamlines the process of booking doctor appointments and managing patient records',
      features: [
        'User-friendly interface for scheduling and managing appointments',
        'Secure patient record management with data encryption',
      ...
      githubUrl: 'https://github.com/Abhishek00024/Doctors_Appointment_Booking',
      deployUrl: 'https://6a1b258149268e7fecb79dba--super-otter-32abd1.netlify.app/',
