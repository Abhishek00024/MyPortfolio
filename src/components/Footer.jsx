...
export default function Footer({ darkMode }) {
  ...
  const socialLinks = [
    { icon: <Linkedin className="w-4 h-4" />, url: 'https://www.linkedin.com/in/abhishek-singh-a3623b363/', colorClass: 'hover:text-cyber-cyan hover:shadow-neon-cyan hover:border-cyber-cyan' },
    { icon: <Github className="w-4 h-4" />, url: 'https://github.com/Abhishek00024', colorClass: 'hover:text-violet-400 hover:shadow-neon-violet hover:border-violet-500' },
