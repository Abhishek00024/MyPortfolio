      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-5 flex flex-col space-y-6 text-left">
          ...
          <div className="space-y-4">
            {/* Email link */}
            <a
              href="mailto:abhisheksingh80024@gmail.com"
            ...
            >
              ...
              <div>
                ...
                <span className="text-sm sm:text-base font-semibold">abhisheksingh80024@gmail.com</span>
              </div>
            </a>

            {/* Phone link */}
            <a
              href="tel:73678563037"
              className={`flex items-center gap-4 p-4 rounded-xl border transition-all duration-300 hover:scale-102 ${
                darkMode 
            ...
            >
              ...
              <div>
                ...
                <span className="text-sm sm:text-base font-semibold">7367853037</span>
              </div>
            </a>
